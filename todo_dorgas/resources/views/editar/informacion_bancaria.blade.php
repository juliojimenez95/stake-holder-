...
<body>
  <div class="container-fluid">
    ...
    <div class="container">
      <form action="{{ route('editInformacionb',$id) }}" method="POST">
            @csrf
            @method('put')
                ...
                <div class="row">
                        ...
                        <div>
                            ...
                            <div class="">
                                    <select class="form-control select_cus_b" aria-label="Seleccione un banco" name="banco">
                                        <option value=" {{ $informacion->Banco }}">{{ $informacion->Banco }}</option>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="">
                                    <select class="form-control select_cus_t" aria-label="Tipo de cuenta" name="cuenta">
                                        <option value="{{ $informacion->TipoCuenta }}">{{ $informacion->TipoCuenta }}</option>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control input_custom" name="n_cuenta" value="{{ $informacion->Cuenta }}">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select  class="form-control select_custom" aria-label="Default select example" id="departamento" name="departamento">
                                    <option  value="{{ $informacion->Pais }}">{{ $informacion->Pais }}</option>
                ...
                <div class="row">
                            ...
                            <div class="">
                                <div>
                                    <select class="form-control select_cus_b" aria-label="Seleccione un banco" name="banco2">
                                        @if ($informacion->Banco2)
                                        <option value="{{ $informacion->Banco2 }}">{{ $informacion->Banco2 }}</option>
                    ...
                    <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="">
                                    <select class="form-control select_cus_t" aria-label="Tipo de cuenta" name="cuenta2">
                                        @if ($informacion->TipoCuenta2)
                                        <option value="{{ $informacion->TipoCuenta2 }}">{{ $informacion->TipoCuenta2 }}</option>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" class="form-control input_custom"name="n_cuenta2" value="{{ $informacion->Cuenta2 }}">
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select class="form-control select_custom" id="departamento2" name="departamento2">
                                    <option value="{{ $informacion->Departamento2 }}">{{ $informacion->Departamento2 }}</option>
                                </select>
                            </div>
