                        ...
                        <form action=" {{ route('proveedor.pn') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <label for="razon_s" class="form-label label_c"><strong>Razon social</strong></label>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <label for="nit" class="form-label label_c"><strong>Nit</strong></label>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <label for="tipo_s" class="form-label label_c"><strong>Tipo sociedad</strong></label>
                                    <select class="form-select select_c" aria-label="Default select example" name="tipo_s">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <label for="pais" class="form-label label_c"><strong>Pais</strong></label>
                                        <select  class="form-select select_c" aria-label="Default select example" id="pais" name="pais">
                                        <option  value="{{old('pais')}}">Seleccione una pais...</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <label for="ta_e" class="form-label label_c"><strong>Tamaño de la empresa</strong></label>
