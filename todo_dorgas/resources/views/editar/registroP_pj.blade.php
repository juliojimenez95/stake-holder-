                        ...
                        <form action=" {{ route('proveedor.storepj') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <input type="id" class="form-control input_custom select_c" id="id" name="id" value="{{ $user->Nit}}"
                                        placeholder="">
                                    @if ($errors->has('id'))
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <input type="text" class="form-control input_custom select_c" id="dv" name="dv" value="{{$user->DV}}"
                                        placeholder="">
                                    @if ($errors->has('dv'))
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <select class="form-control select_custom" aria-label="Default select example" name="tipo_s">
                                        <option value="{{$user->tipo_s}}">{{$user->tipo_s}}</option>
